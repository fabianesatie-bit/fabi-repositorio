 ...
 * Otimizado com Carregamento Progressivo Assíncrono (Respostas Iniciais em ~1.5s)
 */
...
/**
 * ETAPA 1 (CARREGAMENTO INICIAL INSTANTÂNEO):
 * Retorna em ~1.5s apenas os dados primários para renderizar a Home Inicial
 ...
 * @return {Object} Payload leve para abertura rápida da UI
 */
 ...
 * @return {Object} Lojas, Indicadores, Naturezas e Temas
 */
